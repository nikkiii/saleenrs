...
public class Damage {
	...
	public static enum HitType {
		...
		DISEASE_DAMAGE(3), // disease
		MELEE_DAMAGE(4), // Melee Damage
		RANGE_DAMAGE(5), // Range Damage
		MAGIC_DAMAGE(6), // Magic Damage
		SOAKED_DAMAGE(7), // A soaked hit
		DEFLECT_DAMAGE(8), // A deflected damage
		CANNON_DAMAGE(9); // Cannon Damage
		 ...
		 * 
		 * @param type
		 *            The corresponding integer for damage type.
		 */
