...
public class Skills {
	...
	public void addExperience(int skill, double exp) {
		...
		player.getActionSender().sendSkill(skill);
		player.getActionSender().sendXPCounter(skill, (int) exp);
	}
	 ...
	 *            The modifier
	 */
	public void modifyLevel(int skill, double modifier) {
		double modified = levels[skill] * modifier;
		levels[skill] = (int) (levels[skill] + modified);
	}
