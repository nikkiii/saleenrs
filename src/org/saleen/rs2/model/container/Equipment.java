...
public class Equipment {
	...
	public static int PLATEBODY[] = { 636, 638, 640, 642, 644, 426, 8031, 8027,
			...
			5575, 6341, 6351, 3387, 5030, 5032, 5034, 7392, 11724 };
	...
	public enum EquipmentType {
		CAPE("Cape", Equipment.SLOT_CAPE), BOOTS("Boots", Equipment.SLOT_BOOTS), GLOVES(
				...
				Equipment.SLOT_HELM), WEAPON("Weapon", Equipment.SLOT_WEAPON);
	...
	/**
	 * Get the equipment type map
	 * 
	 * @return The map of equipment types
	 */
	public static Map<Integer, EquipmentType> getTypes() {
		return equipmentTypes;
	}

	/**
	 * Get the equipment type enum constant for the slot
	 * 
	 * @param slot
	 *            The slot to check
	 * @return The type if found
	 */
	public static EquipmentType getTypeForInteger(int slot) {
